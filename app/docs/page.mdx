...
## Inspiration Behind Dex UI

Dex UI draws inspiration from leading resources in the web development community:
...
Dex UI is inspired by the best practices and innovative designs from **Motion Primitives** and **Shadcn UI**.
